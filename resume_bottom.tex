\begin{minipage}[t]{0.7\hsize} % History
	...
	\section{Employment Experience}
		...
		\begin{tabular}{p{0.75\columnwidth}p{0.25\columnwidth}}
			\resumeitem{Web Developer} & \resumedate{Apr 2016 - Present}\\
			...
			\resumedetails{\textbullet \, \parbox[t]{0.95\hsize}{Performed backend and frontend web development utilizing modern technologies and frameworks such as AngularJS, Node.js, \\MongoDB, Gulp.js and Grunt}} &\\
			\\
	...
	\section{Portfolio}
		...
		\begin{tabular}{p{0.75\columnwidth}p{0.25\columnwidth}}
			...
			\resumedetails{\textbullet \, Over 700 copies sold to players, with a revenue of over \$5,500} &\\
			\\
