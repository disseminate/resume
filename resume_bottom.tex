\begin{minipage}[t]{0.7\hsize} % History
	...
	\section{Employment Experience}
		...
		\begin{tabular}{p{0.75\columnwidth}p{0.25\columnwidth}}
			\resumeitem{Programmer} & \resumedate{Feb 2015 - Present}\\
	...
	\section{Portfolio}
		...
		\begin{tabular}{p{0.75\columnwidth}p{0.25\columnwidth}}
			...
			\resumedetails{\textbullet \, Over 575 copies sold to players, with a revenue of over \$3,800} &\\
			\\
			...
			\resumedetails{\textbullet \, \href{http://uwogym.com}{http://uwogym.com}} &
		\end{tabular}
